  ...
  return (
    <div className="bg-slate-200 py-24 flex flex-col items-center">
      ...
      <div className="flex gap-16 items-center justify-center flex-wrap">
        <div className="flex flex-col items-center py-10 px-4  rounded-lg  shadow-xl hover:bg-purple-100 hover: bg-purple-200 transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110">
          <img
        ...
        <div className="flex flex-col items-center py-10 px-4  rounded-lg  shadow-xl hover:bg-red-100 bg-red-200 transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110">
          <img
            className="w-80 h-[350px] rounded-lg shadow-lg"
        ...
        <div className="flex flex-col items-center py-10 px-4  rounded-lg  shadow-xl hover:bg-green-50 bg-green-100 transition delay-150 duration-300 ease-in-out hover:-translate-y-1 hover:scale-110">
          <img
            className="w-80 h-[350px] rounded-lg shadow-lg"
